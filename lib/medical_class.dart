...
// nội dung phương án cho không đạt mục tiêu ở phương án sử dụng trên
  ...
  void setChangeStatus() {
    if (!checkBreak) {
      if (!this.checkCurrentGlucose) {
        ...
        } else if (getCheckOpenCloseTimeStatus("6:31", "8:59")) {
          this._content_display =
              "Bạn phải đợi đến 9h  để đo đường máu mao mạch";
        } else if (getCheckOpenCloseTimeStatus("9:00", "9:30")) {
          if (this.checkDoneTask) {
            this._content_display =
        ...
        } else if (getCheckOpenCloseTimeStatus("9:31", "11:59")) {
          this._content_display =
              "Bạn phải đợi đến 12h để đo đường máu mao mạch";
        } else if (getCheckOpenCloseTimeStatus("12:00", "12:30")) {
          if (this.checkDoneTask) {
            this._content_display =
                "Bạn phải đợi đến 15h để đo đường máu mao mạch";
          } else {
            if (getCheckGlucozo(this.getLastFaildedResultValue()) == 1) {
              this._setSloveFailedContext(2);
              this._content_display += this.sloveFailedContext;
        ...
        } else if (getCheckOpenCloseTimeStatus("12:31", "14:59")) {
          this._content_display =
              "Bạn phải đợi đến 15h để đo đường máu mao mạch";
        } else if (getCheckOpenCloseTimeStatus("15:00", "15:30")) {
          if (this.checkDoneTask) {
            this._content_display =
        ...
        } else if (getCheckOpenCloseTimeStatus("15:31", "17:59")) {
          this._content_display =
              "Bạn phải đợi đến 18h để đo đường máu mao mạch";
        } else if (getCheckOpenCloseTimeStatus("18:00", "18:30")) {
          if (this.checkDoneTask) {
            this._content_display =
                "Bạn phải đợi đến 21h để đo đường máu mao mạch";
          } else {
            this._content_display += "${glucose_infusion_6H12H22H}";
            if (getCheckGlucozo(this.getLastFaildedResultValue()) == 1) {
              this._setSloveFailedContext(2);
        ...
        } else if (getCheckOpenCloseTimeStatus("18:31", "20:59")) {
          this._content_display =
              "Bạn phải đợi đến 21h để đo đường máu mao mạch";
        } else if (getCheckOpenCloseTimeStatus("21:00", "21:30")) {
          if (this.checkDoneTask) {
            this._content_display =
  ...
  bool checkValidMeasuringTimeFocus() {
    if (getCheckOpenCloseTimeStatus('6:00', '6:30') ||
        getCheckOpenCloseTimeStatus('9:00', '9:30') ||
        getCheckOpenCloseTimeStatus('12:00', '12:30') ||
        getCheckOpenCloseTimeStatus('15:00', '15:30') ||
        getCheckOpenCloseTimeStatus('18:00', '18:30') ||
        getCheckOpenCloseTimeStatus('21:00', '21:30')) {
      return true;
    }
    return false;
  }
  ...
  void timeNextCurrentValid() {
    if (getCheckOpenCloseTimeStatus('6:31', '9:30')) {
      this.timeNext = '9:00_9:30';
    } else if (getCheckOpenCloseTimeStatus('9:31', '12:30')) {
      this.timeNext = '12:00_12:30';
    } else if (getCheckOpenCloseTimeStatus('12:31', '15:30')) {
      this.timeNext = '15:00_15:30';
    } else if (getCheckOpenCloseTimeStatus('15:31', '18:30')) {
      this.timeNext = '18:00_18:30';
    } else if (getCheckOpenCloseTimeStatus('18:31', '21:30')) {
      this.timeNext = '21:00_21:30';
    } else {
